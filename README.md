...
### Why using python3?
Becuase every morden computer have python3 preinstalled, so Python3 become the better options to build this tools. About the "Windows" side, althrough Python3 is no preinstalled, but you can use docker or WSL to run this script as well.
